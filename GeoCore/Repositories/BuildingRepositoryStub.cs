...
namespace GeoCore.Repositories
{
    public class BuildingRepositoryStub : IBuildingRepository
    {
        private readonly List<Building> _buildings = new()
        {
            ...
            new Building { BuildingId = "BLD002", BuildingCode = "BLD002", Name = "Edificio Diagonal", Address = "Avinguda Diagonal 211", City = "Barcelona", Latitude = 41.394897, Longitude = 2.140408, PurchaseDate = DateTime.Parse("2021-05-15"), Status = "Rented", PostalCode = "08018" },
            new Building { BuildingId = "BLD003", BuildingCode = "BLD003", Name = "Edificio Constitución", Address = "Avenida de la Constitución 1", City = "Sevilla", Latitude = 37.388797, Longitude = -5.994461, PurchaseDate = DateTime.Parse("2022-03-10"), Status = "Under Maintenance", PostalCode = "41004" },
            new Building { BuildingId = "BLD004", BuildingCode = "BLD004", Name = "Edificio Paz", Address = "Calle de la Paz 15", City = "Valencia", Latitude = 39.473889, Longitude = -0.375278, PurchaseDate = DateTime.Parse("2019-07-22"), Status = "Active", PostalCode = "46003" },
            new Building { BuildingId = "BLD005", BuildingCode = "BLD005", Name = "Edificio Gran Vía", Address = "Gran Vía 20", City = "Bilbao", Latitude = 43.263012, Longitude = -2.935003, PurchaseDate = DateTime.Parse("2018-11-30"), Status = "Rented", PostalCode = "48009" },
            new Building { BuildingId = "BLD006", BuildingCode = "BLD006", Name = "Edificio Reyes Católicos", Address = "Calle Reyes Católicos 17", City = "Granada", Latitude = 37.176487, Longitude = -3.599556, PurchaseDate = DateTime.Parse("2020-06-15"), Status = "Active", PostalCode = "18009" },
            new Building { BuildingId = "BLD007", BuildingCode = "BLD007", Name = "Edificio Independencia", Address = "Paseo Independencia 24", City = "Zaragoza", Latitude = 41.649693, Longitude = -0.887712, PurchaseDate = DateTime.Parse("2021-02-20"), Status = "Under Maintenance", PostalCode = "50001" },
            ...
            new Building { BuildingId = "BLD009", BuildingCode = "BLD009", Name = "Edificio Maisonnave", Address = "Avenida Maisonnave 41", City = "Alicante", Latitude = 38.345170, Longitude = -0.483034, PurchaseDate = DateTime.Parse("2022-01-05"), Status = "Rented", PostalCode = "03003" },
