...
namespace GeoCore.Repositories
{
    public class BuildingRepositoryStub : IBuildingRepository
    {
        ...
        {
            new Building { BuildingId = "BLD001", BuildingCode = "BLD001", Name = "Edificio Central", Address = "Calle Mayor 1", City = "Madrid", Latitude = 40.416775, Longitude = -3.703790, PurchaseDate = DateTime.Parse("2020-01-01"), Status = "Active" },
            ...
            new Building { BuildingId = "BLD003", BuildingCode = "BLD003", Name = "Edificio Constitución", Address = "Avenida de la Constitución 1", City = "Sevilla", Latitude = 37.388630, Longitude = -5.995340, PurchaseDate = DateTime.Parse("2022-03-10"), Status = "Under Maintenance" },
            new Building { BuildingId = "BLD004", BuildingCode = "BLD004", Name = "Edificio Paz", Address = "Calle de la Paz 15", City = "Valencia", Latitude = 39.474510, Longitude = -0.376288, PurchaseDate = DateTime.Parse("2019-07-22"), Status = "Active" },
            new Building { BuildingId = "BLD005", BuildingCode = "BLD005", Name = "Edificio Gran Vía", Address = "Gran Vía 20", City = "Bilbao", Latitude = 43.263013, Longitude = -2.935003, PurchaseDate = DateTime.Parse("2018-11-30"), Status = "Rented" },
