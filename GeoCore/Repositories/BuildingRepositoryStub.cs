...
namespace GeoCore.Repositories
{
    public class BuildingRepositoryStub : IBuildingRepository
    {
        ...
        {
            // Coordenadas reales obtenidas por geocodificación para cada dirección
            new Building { BuildingId = "BLD001", BuildingCode = "BLD001", Name = "Edificio Central", Address = "Calle Mayor 1", City = "Madrid", Latitude = 40.417002, Longitude = -3.707382, PurchaseDate = DateTime.Parse("2020-01-01"), Status = "Active" },
            new Building { BuildingId = "BLD002", BuildingCode = "BLD002", Name = "Edificio Diagonal", Address = "Avinguda Diagonal 211", City = "Barcelona", Latitude = 41.397739, Longitude = 2.190246, PurchaseDate = DateTime.Parse("2021-05-15"), Status = "Rented" },
            new Building { BuildingId = "BLD003", BuildingCode = "BLD003", Name = "Edificio Constitución", Address = "Avenida de la Constitución 1", City = "Sevilla", Latitude = 37.388997, Longitude = -5.994972, PurchaseDate = DateTime.Parse("2022-03-10"), Status = "Under Maintenance" },
            new Building { BuildingId = "BLD004", BuildingCode = "BLD004", Name = "Edificio Paz", Address = "Calle de la Paz 15", City = "Valencia", Latitude = 39.473985, Longitude = -0.375426, PurchaseDate = DateTime.Parse("2019-07-22"), Status = "Active" },
            new Building { BuildingId = "BLD005", BuildingCode = "BLD005", Name = "Edificio Gran Vía", Address = "Gran Vía 20", City = "Bilbao", Latitude = 43.263207, Longitude = -2.934992, PurchaseDate = DateTime.Parse("2018-11-30"), Status = "Rented" },
            ...
            new Building { BuildingId = "BLD010", BuildingCode = "BLD010", Name = "Edificio Estafeta", Address = "Calle Estafeta 1", City = "Pamplona", Latitude = 42.816873, Longitude = -1.644634, PurchaseDate = DateTime.Parse("2020-03-18"), Status = "Active" }
        };
